...
Array.prototype.even = function () {
  return this.filter((num) => typeof num === 'number' && num % 2 === 0 && Number.isInteger(num));
};
...
Array.prototype.under = function (x) {
  return this.filter((num) => typeof num === 'number' && num < x && Number.isInteger(num));
};
...
Array.prototype.inRange = function (min, max) {
  return this.filter((num) => typeof num === 'number' && num >= min && num <= max && Number.isInteger(num));
};